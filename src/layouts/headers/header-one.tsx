...
const logo = "/assets/img/logo/religh-logo.svg";
const logoWhite = "/assets/img/logo/religh-logo-white.svg";
              ...
              <div className="col-xl-2 col-lg-2 col-6">
                <div className="tp-header-logo">
                  <Link className="logo-1" href="/">
                    <Image style={{ width: "auto", height: "auto" }} src={logo} alt="Religh Technologies" width={140} height={50} />
                  </Link>
                  <Link className="logo-2" href="/">
                    <Image style={{ width: "auto", height: "auto" }} src={logoWhite} alt="Religh Technologies" width={140} height={50} />
                  </Link>
                </div>
              </div>
